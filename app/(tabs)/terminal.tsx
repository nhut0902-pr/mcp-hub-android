...
import { hasNativeMcpHubRuntime } from "@/lib/mcp-hub/native-runtime";
...
export default function TerminalScreen() {
  ...
  const nativeTerminalAvailable = Platform.OS === "android" && hasNativeMcpHubRuntime;
