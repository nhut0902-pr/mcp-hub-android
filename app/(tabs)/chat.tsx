...
export default function ChatScreen() {
  ...
  const addFile = async () => {
    ...
    try {
      ...
      setAttachments((current) => [...current, { id: `file-${Date.now()}`, type: "file", label: asset.name, uri: asset.uri, mimeType: asset.mimeType, size: asset.size }]);
      setToolNotice({ title: "Đã chọn tệp", detail: `${asset.name} sẽ được đưa vào ngữ cảnh tin nhắn dưới dạng thông tin tệp.`, tone: "success" });
  ...
  return <ScreenContainer edges={["top", "bottom", "left", "right"]}><View style={styles.screen} testID="chat-screen">
    ...
    <ChatToolsSheet visible={toolsVisible} servers={state.mcpServers} attachments={attachments} busyTool={busyTool} onClose={() => setToolsVisible(false)} onToggleMcp={(server, enabled) => void toggleMcpServer(server.id, enabled)} onTool={(tool) => void useTool(tool)} onRemoveAttachment={removeAttachment} />
...
const styles = StyleSheet.create({
  ...
  header: { height: 56, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", borderBottomWidth: 1, borderColor: "#303030" },
  ...
  toolNoticeSuccess: { backgroundColor: "#173B30", borderWidth: 1, borderColor: "#276B57" },
  toolNoticeError: { backgroundColor: "#3C2525", borderWidth: 1, borderColor: "#7C4545" },
  toolNoticeTitle: { fontSize: 11, fontWeight: "800" },
  toolNoticeDetail: { color: "#C1C1C1", fontSize: 10, lineHeight: 15, marginTop: 2 },
  chatList: { flex: 1 },
  ...
  systemPrompt: { alignSelf: "flex-start", maxWidth: "92%", flexDirection: "row", alignItems: "center", gap: 7, backgroundColor: "#D86B37", borderRadius: 12, paddingHorizontal: 11, paddingVertical: 8, marginBottom: 4 },
  ...
  assistantBubble: { backgroundColor: "#3A3A3A", borderBottomLeftRadius: 5 },
  messageText: { color: palette.text, fontSize: 13, lineHeight: 20 },
  userText: { color: "#FFFFFF" },
  failureCard: { backgroundColor: "#3C2525", borderColor: "#B94444", gap: 8 },
  failureHead: { flexDirection: "row", alignItems: "center", gap: 7 },
  failureTitle: { color: "#FF7676", fontSize: 13, fontWeight: "800" },
  failureModel: { color: "#BDBDBD", fontSize: 10, fontFamily: "monospace" },
  failureDetail: { color: "#E2C0C0", fontSize: 12, lineHeight: 17 },
  failureAction: { color: "#FF8A8A", fontSize: 11, lineHeight: 16, fontWeight: "700" },
  retryButton: { alignSelf: "flex-start", flexDirection: "row", gap: 6, alignItems: "center", paddingVertical: 7, paddingHorizontal: 10, backgroundColor: "#684040", borderRadius: 9 },
  retryText: { color: "#FFFFFF", fontSize: 11, fontWeight: "800" },
  reasonCard: { backgroundColor: "#3A3A3A", borderRadius: 14, padding: 12, gap: 7 },
  reasonHead: { flexDirection: "row", gap: 7, alignItems: "center" },
  reasonTitle: { color: "#F5D25A", fontSize: 12, fontWeight: "800", textDecorationLine: "underline" },
  reasonText: { color: "#C4C4C4", fontSize: 12, lineHeight: 18, borderLeftWidth: 3, borderColor: "#F5D25A", paddingLeft: 9 },
  attachmentPreview: { gap: 6 },
  attachmentImage: { width: 164, height: 108, borderRadius: 11 },
  locationChip: { flexDirection: "row", gap: 6, alignItems: "center", paddingHorizontal: 9, paddingVertical: 7, borderRadius: 9, backgroundColor: "#313F4B" },
  locationChipText: { color: "#BFE1FF", fontSize: 10, maxWidth: 210 },
  citationWrap: { paddingLeft: 7, gap: 3 },
  citationLabel: { color: palette.muted, fontSize: 10, fontWeight: "800" },
  citationText: { color: "#6DBBFF", fontSize: 11 },
  sending: { paddingHorizontal: 16, paddingVertical: 7 },
  composerWrap: { paddingHorizontal: 10, paddingTop: 8, paddingBottom: 10, gap: 7, borderTopWidth: 1, borderColor: "#282828" },
  pendingRow: { flexDirection: "row", gap: 6, flexWrap: "wrap" },
  pendingChip: { maxWidth: 200, flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "#313F4B", borderRadius: 9, paddingHorizontal: 8, paddingVertical: 6 },
  pendingText: { flexShrink: 1, color: "#BFE1FF", fontSize: 10 },
  composer: { minHeight: 116, padding: 12, borderRadius: 21, backgroundColor: "#383838", position: "relative" },
  composerInput: { color: palette.text, fontSize: 13, lineHeight: 19, minHeight: 43, paddingRight: 42, textAlignVertical: "top" },
  sendButton: { position: "absolute", right: 12, top: 12, width: 38, height: 38, borderRadius: 19, backgroundColor: "#E7E7E7", alignItems: "center", justifyContent: "center" },
  ...
  contextText: { marginLeft: "auto", color: "#A8A8A8", fontSize: 10, fontWeight: "700" },
  modelSelect: { maxWidth: 136, flexDirection: "row", alignItems: "center", gap: 5 },
  smallModelIcon: { width: 20, height: 20, borderRadius: 7, backgroundColor: "#FB7A3E", alignItems: "center", justifyContent: "center" },
  modelSelectText: { color: "#F0F0F0", fontSize: 11, fontWeight: "700", flexShrink: 1 },
  drawerOverlay: { flex: 1 },
  drawerScrim: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(0,0,0,.62)" },
  drawer: { position: "absolute", top: 0, bottom: 0, left: 0, width: "74%", backgroundColor: "#474747", paddingTop: 19, paddingHorizontal: 13 },
  ...
  brandIcon: { width: 28, height: 28, borderRadius: 8, backgroundColor: "#626262", alignItems: "center", justifyContent: "center" },
  brandTitle: { color: "#FFFFFF", fontSize: 19, fontWeight: "800" },
  version: { color: "#B0B0B0", fontSize: 12 },
  drawerSection: { color: "#B2B2B2", fontSize: 12, fontWeight: "800", paddingHorizontal: 8, paddingTop: 16, paddingBottom: 6 },
  drawerRow: { minHeight: 49, flexDirection: "row", gap: 14, alignItems: "center", paddingHorizontal: 8 },
  drawerText: { color: "#F4F4F4", fontSize: 14, flex: 1 },
  drawerFooter: { marginTop: "auto", paddingBottom: 15, gap: 8 },
  drawerPrimary: { height: 45, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, borderRadius: 23, backgroundColor: "#92C9EE" },
  drawerPrimaryText: { color: "#173040", fontSize: 13, fontWeight: "800" },
  drawerNav: { flexDirection: "row", justifyContent: "space-around", paddingTop: 8 },
  drawerNavItem: { alignItems: "center", gap: 2 },
  drawerNavText: { color: "#D0D0D0", fontSize: 9, fontWeight: "700" },
  sheetRoot: { flex: 1, justifyContent: "flex-end" },
  sheetScrim: { flex: 1, backgroundColor: "rgba(0,0,0,.66)" },
  modelSheet: { height: "74%", backgroundColor: "#232323", borderTopLeftRadius: 25, borderTopRightRadius: 25, borderWidth: 1, borderColor: "#666", paddingTop: 8 },
  ...
  grabber: { alignSelf: "center", width: 56, height: 4, borderRadius: 3, backgroundColor: "#7B7B7B", marginBottom: 12 },
  segment: { flexDirection: "row", marginHorizontal: 16, borderRadius: 18, backgroundColor: "#404040", padding: 3 },
  segmentButton: { flex: 1, alignItems: "center", paddingVertical: 8, borderRadius: 15 },
  segmentActive: { backgroundColor: "#515151" },
  segmentText: { color: "#C1C1C1", fontWeight: "800", fontSize: 12 },
  segmentTextActive: { color: "#FFFFFF" },
  searchBox: { height: 53, marginTop: 10, paddingHorizontal: 18, gap: 10, flexDirection: "row", alignItems: "center", borderBottomWidth: 1, borderColor: "#363636" },
  searchInput: { flex: 1, color: palette.text, fontSize: 14, height: 50 },
  providerCaption: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#484848", paddingHorizontal: 18, paddingVertical: 8 },
  providerCaptionText: { color: "#E4E4E4", fontSize: 12, fontWeight: "800" },
  byok: { color: "#A6A6A6", fontSize: 10, fontWeight: "800" },
