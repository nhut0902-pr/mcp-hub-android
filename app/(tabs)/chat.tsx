...
const styles = StyleSheet.create({
  ...
  toolNoticeSuccess: { backgroundColor: rgba(16,185,129,0.12), borderWidth: 1, borderColor: rgba(16,185,129,0.3) },
  toolNoticeError: { backgroundColor: rgba(239,68,68,0.12), borderWidth: 1, borderColor: rgba(239,68,68,0.3) },
  toolNoticeInfo: { backgroundColor: rgba(59,130,246,0.12), borderWidth: 1, borderColor: rgba(59,130,246,0.3) },
  ...
  failureCard: { backgroundColor: rgba(239,68,68,0.12), borderColor: rgba(239,68,68,0.4), gap: 8 },
  ...
  retryButton: { alignSelf: "flex-start", flexDirection: "row", gap: 6, alignItems: "center", paddingVertical: 7, paddingHorizontal: 10, backgroundColor: rgba(239,68,68,0.2), borderRadius: 9 },
