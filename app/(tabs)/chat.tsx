...
function isExplicitMcpAction(text: string): boolean {
  return /\b(tạo|thêm|sửa|cập nhật|xoá|xóa|gửi|đăng|viết|đọc|tìm|liệt kê|create|add|update|delete|send|post|write|read|list|search)\b/i.test(text);
}
...
const styles = StyleSheet.create({
  ...
  toolNoticeInfo: { backgroundColor: "#173041", borderWidth: 1, borderColor: "#386986" },
